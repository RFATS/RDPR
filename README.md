# **PEFER**: **P**roduct/**E**nvironment-Induced **F**ailure Probability **E**stimator for **R**etest Decision
Retest 시행 여부를 결정하기 위한 제품/환경성 불량 확률 추정량
...
- 배경: Retest의 양면성
    - 양산 효율 제고
        - Retest를 통한 설비성 불량 구제량은 설비성 불량 확률 $q$에 비례
    - but, fail 이력이 있던 걸 출하하는 게 다소 risky
        - 경미한 제품성 불량이 있는 제품이 restest에서 아슬아슬하게 pass될 수도 있음
            - 이러한 가능성은 제품성 불량 확률 $p$에 비례한다고 가정
- 문제: Retest 시행 여부를 결정할 통계적 기준 마련
